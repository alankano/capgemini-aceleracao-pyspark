...
│
├── scripts
│   ├── census-income.py         <- Contém as respostas de census-income.
│   ├── communities-crime.py     <- Contem as respostas de communities-crime.
│   ├── online-retail.py         <- Contém as respostas de online-retail.
```
